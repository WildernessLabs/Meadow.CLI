...
namespace Meadow.CLI.Commands.DeviceManagement
{
    ...
    public class GetDeviceInfoCommand : MeadowSerialCommand
    {
        ...
        public GetDeviceInfoCommand(DownloadManager downloadManager, ILoggerFactory loggerFactory, MeadowDeviceManager meadowDeviceManager)
        ...
        public override async ValueTask ExecuteAsync(IConsole console)
        {
            ...
            var deviceInfo = await Meadow.GetDeviceInfoAsync(TimeSpan.FromSeconds(60), cancellationToken);
