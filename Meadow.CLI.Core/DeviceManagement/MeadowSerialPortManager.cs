...
{
    public class MeadowSerialPortManager
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            while (attempts < maxAttempts)
            {
                ...
                foreach (var port in ports)
                {
                    ...
                    catch (UnauthorizedAccessException unauthorizedAccessException)
                    {
                        ...
                        {
                            // Eat it and retry
                            logger.LogDebug(unauthorizedAccessException, "This error can be safely ignored.");
                        }
                        else
                        {
                    ...
                    {
                        // Eat it and retry
                        logger.LogDebug(ioException, "This error can be safely ignored.");
                    }
                    catch (MeadowDeviceException meadowDeviceException)
                    {
                        // eat it for now
                        logger.LogDebug(meadowDeviceException, "This error can be safely ignored.");
                    }
                }
            ...
            throw new DeviceNotFoundException($"Could not find a connected Meadow with the serial number {serialNumber}");
        }
