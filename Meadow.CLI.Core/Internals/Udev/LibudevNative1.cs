...
{
    sealed class LibudevNative1 : LibudevNative
    {
        ...
        [DllImport(libudev, EntryPoint = "udev_enumerate_add_match_property")]
        static extern int native_udev_enumerate_add_match_property(IntPtr enumerate,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string attrib, string value);
        public override int udev_enumerate_add_match_property(IntPtr enumerate, string attrib, string value)
        {
            return native_udev_enumerate_add_match_property(enumerate, attrib, value);
        }

        [DllImport(libudev, EntryPoint = "udev_enumerate_add_match_sysattr")]
        static extern int native_udev_enumerate_add_match_sysattr(IntPtr enumerate,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string attrib, string value);
        public override int udev_enumerate_add_match_sysattr(IntPtr enumerate, string attrib, string value)
        {
            return native_udev_enumerate_add_match_sysattr(enumerate, attrib, value);
        }
        ...
        [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))]
        static extern string native_udev_device_get_sysname(IntPtr device);
        public override string udev_device_get_sysname(IntPtr device)
        {
            return native_udev_device_get_sysname(device);
        }
        ...
        static extern string native_udev_device_get_property_value(IntPtr device,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string property);
        public override string udev_device_get_property_value(IntPtr device, string property)
        {
            return native_udev_device_get_property_value(device, property);
        }
