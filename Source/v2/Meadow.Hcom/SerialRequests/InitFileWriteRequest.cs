...
internal static class NuttxCrc
{
    //==============================================================
    ...
    public static uint Crc32part(byte[] buffer, uint length, uint offset, uint crc32val)
    {
    ...
    public static uint Crc32part(byte[] buffer, uint length, uint crc32val)
    {
...
internal class InitFileWriteRequest : Request
{
    ...
    public uint FlashAddress { get; set; }
